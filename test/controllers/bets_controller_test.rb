...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { home_goals: @bet.home_goals, visitor_goals: @bet.visitor_goals } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { home_goals: @bet.home_goals, visitor_goals: @bet.visitor_goals } }
